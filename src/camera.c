...
// Camera createCamera(vec2s size, vec3s pos, float fov, float sensivity)
// {
// 	Camera cam = {
...
// void cameraVectorUpdate(Camera *cam, Mouse *mouse)
// {
// 	cam->yaw   += mouse->delta.x * cam->sensivity;
// 	cam->pitch += mouse->delta.y * cam->sensivity;
